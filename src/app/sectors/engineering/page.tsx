                ...
                <div className="max-w-[1240px] mx-auto">
                    ...
                    >
                        ...
                        <p className="subtitle max-w-[920px] mx-auto font-normal text-[#475569]">
                            Reliable, consultant-verified engineering staff supplied across Glasgow, Edinburgh, Falkirk (see our dedicated <Link href="/locations/falkirk" className="text-blue-600 hover:underline">Recruitment Agency Falkirk</Link> page), Stirling, Livingston, Cumbernauld, Aberdeen, Dundee, throughout Scotland, and across the UK.
                        </p>
                    </motion.div>
