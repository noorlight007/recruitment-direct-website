                ...
                <div className="rd-footer-columns">
                  ...
                  <div className="footer-col">
                    <button
                      type="button"
                      className="footer-col-toggle"
                      onClick={() => toggleMobileSection("getInTouch")}
                      aria-expanded={openMobileSections.getInTouch}
                    >
                      <div className="footer-col-header-content">
                        <h4>Get in Touch</h4>
                        <span className={`footer-col-chevron ${openMobileSections.getInTouch ? "open" : ""}`}>
                          <ChevronDown className="w-4 h-4" />
                        </span>
                      </div>
                    </button>
