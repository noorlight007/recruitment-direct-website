      ...
      <div className="w-full px-6 lg:px-10">
        <div className="flex items-center justify-between h-28">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            >
              <div className="p-2 rounded-lg group-hover:bg-[#25D366]/20 transition-colors">
            ...
            <a href="tel:01324613198" className="flex items-center gap-2 text-foreground font-medium hover:text-primary transition-colors group">
          ...
          >
            <div className="px-4 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex items-center gap-4 px-4 py-2 border-t border-primary/5 pt-4">
                <a href="https://wa.me/447590882626" target="_blank" rel="noopener noreferrer" className="p-2 transition-opacity hover:opacity-80 rounded-full bg-[#25D366]/10">
