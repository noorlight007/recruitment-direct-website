...
const menuItems = [
  ...
  { label: "Job Search", href: "/job_details" },
        ...
        <div className="flex items-center justify-between h-20 lg:h-24">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <div className="header-social-icons">
              ...
              <a href="https://www.linkedin.com/company/recruitment-direct/?utm_source=chatgpt%2Ecom&originalSubdomain=uk" target="_blank" rel="noopener noreferrer">
